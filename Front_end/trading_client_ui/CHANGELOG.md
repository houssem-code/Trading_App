...
## [1.3.0] 2019-05-03
### Bug fixing
- Renamed `src/layouts/Dashboard/Dashboard.jsx` to `src/app/platform/layouts/Admin.jsx`
- Renamed `src/views/Dashboard/Dashboard.jsx` to `src/app/platform/views/Dashboard.jsx`
- Renamed `src/views/Dashboard/Dashboard.jsx` to `src/app/platform/views/Icons.jsx`
- Renamed `src/views/Dashboard/Dashboard.jsx` to `src/app/platform/views/Maps.jsx`
- Renamed `src/views/Dashboard/Dashboard.jsx` to `src/app/platform/views/Notifications.jsx`
- Renamed `src/views/Dashboard/Dashboard.jsx` to `src/app/platform/views/TableList.jsx`
- Renamed `src/views/Dashboard/Dashboard.jsx` to `src/app/platform/views/Typography.jsx`
- Renamed `src/views/Dashboard/Dashboard.jsx` to `src/app/platform/views/Upgrade.jsx`
- Renamed `src/views/Dashboard/Dashboard.jsx` to `src/app/platform/views/UserProfile.jsx`
- Renamed `src/components/Header` to `src/app/platform/components/Navbars`
- Renamed `src/components/Navbars/Header.jsx` to `src/app/platform/components/Navbars/AdminNavbar.jsx`
- Renamed `src/components/Navbars/HeaderLinks.jsx` to `src/app/platform/components/Navbars/AdminNavbarLinks.jsx`
